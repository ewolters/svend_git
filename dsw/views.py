...
def run_analysis(request):
    ...
    from agents_api.analysis.dispatch import run_analysis as _dispatch_analysis
...
def explain_selection(request):
    ...
    return JsonResponse({"explanation": result.content})
    ...
    return JsonResponse(
        {
            "hypothesis": {
                ...
                "statement": (
                    hypothesis.statement if hasattr(hypothesis, "statement") else str(hypothesis.description or "")
                ),
...
def upload_data(request):
    ...
    from agents_api.analysis.endpoints_data import upload_data as _ep_upload_data
...
def execute_code(request):
    """Route to analysis/endpoints_data."""
    from agents_api.analysis.endpoints_data import execute_code as _ep_execute_code
...
def generate_code(request):
    """Route to analysis/endpoints_data."""
    from agents_api.analysis.endpoints_data import generate_code as _ep_generate_code
...
def analyst_assistant(request):
    """Route to analysis/endpoints_data."""
    from agents_api.analysis.endpoints_data import analyst_assistant as _ep_analyst_assistant
...
def transform_data(request):
    """Route to analysis/endpoints_data."""
    from agents_api.analysis.endpoints_data import transform_data as _ep_transform_data
...
def download_data(request):
    """Route to analysis/endpoints_data."""
    from agents_api.analysis.endpoints_data import download_data as _ep_download_data
...
def retrieve_data(request):
    ...
    from agents_api.analysis.endpoints_data import retrieve_data as _ep_retrieve_data
...
def triage_data(request):
    """Route to analysis/endpoints_data."""
    from agents_api.analysis.endpoints_data import triage_data as _ep_triage_data
...
def triage_scan(request):
    """Route to analysis/endpoints_data."""
    from agents_api.analysis.endpoints_data import triage_scan as _ep_triage_scan

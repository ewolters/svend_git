...
def _doe_connect_investigation(request, investigation_id, event_description, tool_type, spec_type="inference"):
    ...
    """
    from agents_api.investigation_bridge import InferenceSpec, IntentSpec, connect_tool
...
def saved_design_detail(request, design_id):
    ...
    try:
        design = ExperimentDesign.objects.select_related("project").get(id=design_id, project__user=request.user)

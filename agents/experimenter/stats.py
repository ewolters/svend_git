...
class PowerAnalyzer:
    ...
    def power_ttest_ind(
        self, effect_size: float, alpha: float = 0.05, power: float = 0.8, ratio: float = 1.0
    ) -> PowerResult:
        """
    ...
    def power_ttest_paired(self, effect_size: float, alpha: float = 0.05, power: float = 0.8) -> PowerResult:
    ...
    def power_anova(self, effect_size: float, groups: int, alpha: float = 0.05, power: float = 0.8) -> PowerResult:
        """
    ...
    def power_chi_square(self, effect_size: float, df: int, alpha: float = 0.05, power: float = 0.8) -> PowerResult:
        """
    ...
    def power_correlation(self, r: float, alpha: float = 0.05, power: float = 0.8) -> PowerResult:
        """
    ...
    def power_proportion(
        self, p1: float, p2: float, alpha: float = 0.05, power: float = 0.8, ratio: float = 1.0
    ) -> PowerResult:
        """
    ...
    def calculate_power_curve(
        self, test_type: str, effect_sizes: list[float], alpha: float = 0.05, sample_size: int = None, **kwargs
...
def sample_size_for_mean(margin_of_error: float, std_dev: float, confidence: float = 0.95) -> SampleSizeResult:
    """
...
def sample_size_for_proportion(margin_of_error: float, p: float = 0.5, confidence: float = 0.95) -> SampleSizeResult:
    """
...
def effect_size_from_means(mean1: float, mean2: float, pooled_std: float) -> float:

                ...
                p_val = (
                    min(
                        ...
                        * (
                            1
                            - stats.t.cdf(
                                np.sqrt((n * (n - 2) * G**2) / (n - 1 - G**2 * (n - 1) / n)),
                                n - 2,
                            )
                        ),
                    )
    ...
    # ── Duplicate Analysis ────────────────────────────────────────────────
        ...
        try:
            ...
            result["narrative"] = _narrative(
                ...
                chart_guidance=(
                    "The histogram shows how many copies exist per duplicate group." if n_dup_rows > 0 else None
                ),
            )
                ...
                "data": [
                    {
                        ...
                        "marker": {
                            "size": 8,
                            "color": ["#4a9f6e" if r["k"] == k_best else "#999" for r in results_k],
                        },
                        "line": {"color": "#4a90d9"},
                    }
                ],

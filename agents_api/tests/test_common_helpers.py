...
class CheckEqualVarianceTest(TestCase):
    ...
    def test_equal_variances(self):
        from agents_api.analysis.common import _check_equal_variance
...
class ModelCacheTest(TestCase):
    ...
    def test_cache_and_retrieve(self):
        from agents_api.analysis.common import cache_model, get_cached_model
    ...
    def test_missing_key_returns_none(self):
        from agents_api.analysis.common import get_cached_model

...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "can_experiment",
                    models.BooleanField(
                        default=True, help_text="Can you run controlled experiments?"
                    ),
                ),
                (
                    "available_data",
                    models.TextField(
                        blank=True, help_text="What data do you have access to?"
                    ),
                ),
                # Living state
                (
                ...
                (
                    "dead_ends",
                    models.JSONField(
                        blank=True, default=list, help_text="Hypotheses we've ruled out"
                    ),
                ),
                # Understanding
                (
                ...
                (
                    "key_uncertainties",
                    models.JSONField(
                        blank=True, default=list, help_text="What we still don't know"
                    ),
                ),
                (
                    "recommended_next_steps",
                    models.JSONField(
                        blank=True, default=list, help_text="Suggested next actions"
                    ),
                ),
                # Bias tracking
                (
        ...
        migrations.AddIndex(
            model_name="problem",
            index=models.Index(
                fields=["user", "status"], name="agents_api__user_id_c8e7a5_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="problem",
            index=models.Index(
                fields=["user", "-updated_at"], name="agents_api__user_id_f3a2d1_idx"
            ),
        ),
    ]

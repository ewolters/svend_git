...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "source_id",
                    models.UUIDField(
                        blank=True, help_text="UUID of the source record", null=True
                    ),
                ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["owner", "status"], name="iso_capas_owner_i_dadfd4_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="capareport",
            index=models.Index(
                fields=["source_type", "source_id"], name="iso_capas_source__568584_idx"
            ),
        ),
    ]

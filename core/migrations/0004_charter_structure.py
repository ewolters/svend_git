    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.CharField(
                blank=True, help_text="Unit of measure for Y", max_length=50
            ),
        ),
        migrations.AddField(
            model_name="hypothesis",
        ...
        migrations.AddField(
            ...
            name="assumptions",
            field=models.JSONField(
                blank=True, default=list, help_text="Assumptions being made [list]"
            ),
        ),
        migrations.AddField(
            model_name="project",
            name="champion_name",
            field=models.CharField(
                blank=True, help_text="Executive sponsor name", max_length=255
            ),
        ),
        migrations.AddField(
            model_name="project",
            name="champion_title",
            field=models.CharField(
                blank=True, help_text="Executive sponsor title", max_length=255
            ),
        ),
        migrations.AddField(
            model_name="project",
        ...
        migrations.AddField(
            ...
            name="goal_target",
            field=models.CharField(
                blank=True, help_text="Target value (e.g., '95%')", max_length=100
            ),
        ),
        migrations.AddField(
            model_name="project",
        ...
        migrations.AddField(
            ...
            name="impact_safety",
            field=models.TextField(
                blank=True, help_text="Safety impact: injuries, near-misses, risk level"
            ),
        ),
        migrations.AddField(
            model_name="project",
            name="leader_name",
            field=models.CharField(
                blank=True, help_text="Project leader name", max_length=255
            ),
        ),
        migrations.AddField(
            model_name="project",
            name="leader_title",
            field=models.CharField(
                blank=True, help_text="Project leader title", max_length=255
            ),
        ),
        migrations.AddField(
            model_name="project",
        ...
        migrations.AddField(
            ...
            field=models.TextField(
                blank=True, help_text="How much? How often? Quantify the problem."
            ),
        ),
        migrations.AddField(
            model_name="project",
        ...
        migrations.AddField(
            ...
            name="scope_in",
            field=models.JSONField(
                blank=True, default=list, help_text="What is IN scope [list of items]"
            ),
        ),
        migrations.AddField(
            model_name="project",
        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                blank=True, help_text="Where this evidence came from", max_length=255
            ),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            ...
            field=models.ManyToManyField(
                blank=True, related_name="hypotheses", to="core.entity"
            ),
        ),
        migrations.AlterField(
            model_name="hypothesis",
        ...
        migrations.AlterField(
            ...
            name="can_experiment",
            field=models.BooleanField(
                default=True, help_text="Can controlled experiments be run?"
            ),
        ),
        migrations.AlterField(
            model_name="project",
            name="constraints",
            field=models.JSONField(
                blank=True, default=list, help_text="Constraints and limitations [list]"
            ),
        ),
        migrations.AlterField(
            model_name="project",
        ...
        migrations.AlterField(
            ...
            field=models.TextField(
                blank=True, help_text="What was the root cause? What did we learn?"
            ),
        ),
        migrations.AlterField(
            model_name="project",
            name="synara_state",
            field=models.JSONField(
                blank=True, help_text="Persisted Synara belief engine state", null=True
            ),
        ),
    ]

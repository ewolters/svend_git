"""C&E Matrix pull contract URL routes."""

from django.urls import path

from . import pull_views

app_name = "ce_matrix_pull"
...
urlpatterns = [
    ...
    path("containers/<uuid:container_id>/delete/", pull_views.delete_with_friction, name="delete_with_friction"),

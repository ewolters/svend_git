"""C&E Matrix pull contract views — expose matrix artifacts for cross-tool integration."""
...
SOURCE_APP = "ce_matrix"
CONTAINER_TYPE = "CEMatrix"


def _queryset(request):
    qs, _, _ = qms_queryset(CEMatrix, request.user)
...
def _sub_artifact(obj, key_path):
    """Retrieve a sub-artifact field from a CEMatrix."""

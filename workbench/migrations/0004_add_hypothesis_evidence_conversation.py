    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "mechanism",
                    models.TextField(
                        blank=True, help_text="How this cause produces the effect"
                    ),
                ),
                (
                    "prior_probability",
                    models.FloatField(
                        default=0.5, help_text="Initial probability estimate (0-1)"
                    ),
                ),
                (
                    "current_probability",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "strength",
                    models.FloatField(
                        default=0.5, help_text="Strength of evidence (0-1)"
                    ),
                ),
                (
                    "source",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "messages",
                    models.JSONField(default=list, help_text="Conversation messages"),
                ),
                (
                    "context",
                    models.JSONField(

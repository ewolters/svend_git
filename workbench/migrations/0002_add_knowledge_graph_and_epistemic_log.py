        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "edges",
                    models.JSONField(
                        blank=True, default=list, help_text="Causal edges with weights"
                    ),
                ),
                (
                    "expansion_signals",
                ...
                (
                    ...
                    models.OneToOneField(
                        blank=True,
                        help_text="Associated workbench (optional - graph can be standalone)",
                        null=True,
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="knowledge_graph",
                        to="workbench.workbench",
                    ),
                ),
            ],
            options={
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            ("evidence_linked", "Evidence Linked to Hypothesis"),
                            ("belief_update", "Belief Updated"),
                            ("belief_propagation", "Belief Propagated"),
                            ("expansion_signal", "Expansion Signal Triggered"),
                            ("expansion_resolved", "Expansion Resolved"),
                            ("node_added", "Node Added to Graph"),
                            ("edge_added", "Edge Added to Graph"),
                            ("edge_weight_updated", "Edge Weight Updated"),
                            ("causal_chain_traced", "Causal Chain Traced"),
                            ("dead_end_identified", "Dead End Identified"),
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="epistemic_l_user_id_c67b14_idx",
                    ),
                    models.Index(
                        fields=["workbench", "-created_at"],
                        name="epistemic_l_workben_ff3cbc_idx",
                    ),
                    models.Index(
                        fields=["knowledge_graph", "-created_at"],
                        name="epistemic_l_knowled_e36eac_idx",
                    ),
                    models.Index(
                        fields=["event_type", "-created_at"],
                        name="epistemic_l_event_t_6fe386_idx",
                    ),
                ],
            },
        ),

...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["user", "status"], name="workbenches_user_id_6a0d45_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="workbench",
            index=models.Index(
                fields=["user", "-updated_at"], name="workbenches_user_id_8afdbe_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="artifact",
            index=models.Index(
                fields=["workbench", "artifact_type"],
                name="artifacts_workben_6df1af_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="artifact",
            index=models.Index(
                fields=["workbench", "created_at"], name="artifacts_workben_50de99_idx"
            ),
        ),
    ]

"""A3 pull contract views — expose A3 Report artifacts for cross-tool integration."""
...
def _queryset(request):
    qs, _, _ = qms_queryset(A3Report, request.user)
...
def _sub_artifact(obj, key_path):
    """Retrieve a sub-artifact field from an A3Report."""

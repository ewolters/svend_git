...
urlpatterns = [
    ...
    path("app/kanban-cards/", TemplateView.as_view(template_name="kanban_cards.html"), name="kanban_cards"),
    ...
    path("app/practice/", TemplateView.as_view(template_name="harada.html"), name="harada"),

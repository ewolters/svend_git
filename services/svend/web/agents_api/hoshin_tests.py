...
class SiteCRUDTest(TestCase):
    ...
    def test_update_site(self):
        ...
        res = _put(
            self.client,
            f"/api/hoshin/sites/{site_id}/update/",
            {
                "name": "New Name",
...
class SiteAccessControlTest(TestCase):
    ...
    def setUp(self):
        ...
        _post(
            self.client,
            f"/api/hoshin/sites/{self.site_id}/members/grant/",
            {
    ...
    def test_viewer_cannot_write_site(self):
        ...
        res = _put(
            self.client,
            f"/api/hoshin/sites/{self.site_id}/update/",
            {
                "name": "Hacked",
            },
        )
...
class MonthlySavingsTest(TestCase):
    ...
    def test_ytd_accumulates(self):
        ...
        for month in [1, 2, 3]:
            _put(
                self.client,
                f"/api/hoshin/projects/{self.hp_id}/monthly/{month}/",
                {
                    "baseline": 3600,
                    "actual": 3000,
                    "volume": 1000,
    ...
    def test_invalid_month_rejected(self):
        res = _put(
            self.client,
            f"/api/hoshin/projects/{self.hp_id}/monthly/0/",
            {
                "baseline": 100,
                "actual": 80,
            },
        ...
        res = _put(
            self.client,
            f"/api/hoshin/projects/{self.hp_id}/monthly/13/",
            {
                "baseline": 100,
                "actual": 80,
            },
...
class ActionItemTest(TestCase):
    ...
    def test_update_action_progress(self):
        ...
        res = _put(
            self.client,
            f"/api/hoshin/actions/{item_id}/update/",
            {
                "status": "in_progress",
                "progress": 50,
            },
...
class VSMPromotionTest(TestCase):
    ...
    def setUp(self):
        ...
        _post(
            self.client,
            f"/api/vsm/{self.current_id}/process-step/",
            {
                "name": "Stamping",
                "cycle_time": 60,
                "x": 100,
        ...
        _post(
            self.client,
            f"/api/vsm/{self.current_id}/kaizen/",
            {
                "text": "SMED press",
                "priority": "high",
                "x": 100,
    ...
    def test_promote_carries_forward_snapshots(self):
        ...
        _post(
            self.client,
            f"/api/vsm/{self.future_id}/process-step/",
            {
                "name": "New Step",
                "cycle_time": 30,
                "x": 200,
    ...
    def test_promote_writebacks_hoshin_savings(self):
        ...
        burst = next(b for b in promoted["kaizen_bursts"] if b["id"] == self.burst_id)

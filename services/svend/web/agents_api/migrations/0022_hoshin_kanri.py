    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "fiscal_year",
                    models.IntegerField(default=2026, help_text="e.g. 2026"),
                ),
                (
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="waste_pct, time_reduction, headcount, claims, freight, energy, direct, layout",
                        max_length=30,
                    ),
                ),
                (
                    ...
                    models.JSONField(
                        blank=True,
                        default=dict,
                        help_text="Kaizen event logistics: {event_date, end_date, location, schedule, event_type, primary_metric, primary_baseline, primary_target, secondary_metric, secondary_baseline, secondary_target, process_start, process_end}",
                    ),
                ),
                (
                    "monthly_actuals",
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["site", "hoshin_status"],
                        name="hoshin_proj_site_id_7b6264_idx",
                    ),
                    models.Index(
                        fields=["fiscal_year", "hoshin_status"],
                        name="hoshin_proj_fiscal__a8cbd1_idx",
                    ),
                ],
            },
        ),

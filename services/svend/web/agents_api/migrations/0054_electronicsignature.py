        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "document_id",
                    models.UUIDField(
                        db_index=True, help_text="UUID of the signed document"
                    ),
                ),
                (
                    "meaning",
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["document_type", "document_id"], name="idx_esig_doc"
                    ),
                    models.Index(
                        fields=["signer", "created_at"], name="idx_esig_signer_time"
                    ),
                    models.Index(
                        fields=["tenant_id", "created_at"], name="idx_esig_tenant_time"
                    ),
                ],
                "constraints": [

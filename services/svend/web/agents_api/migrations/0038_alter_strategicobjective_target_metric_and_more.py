    ...
    operations = [
        migrations.AlterField(
            ...
            field=models.CharField(
                blank=True,
                help_text="Metric catalog key, e.g. 'waste_pct', 'dollar_savings', 'spc_capability'. Links to HoshinKPI.METRIC_CATALOG for unit, direction, and aggregation.",
                max_length=255,
            ),
        ),
        migrations.AlterField(
            ...
            name="target_unit",
            field=models.CharField(
                blank=True, help_text="Auto-filled from metric catalog", max_length=50
            ),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="e.g. SOP, Work Instruction, Policy",
                        max_length=100,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "iso_clauses",
                    models.JSONField(
                        blank=True, default=list, help_text="List of clause refs"
                    ),
                ),
            ...
            fields=[
                ...
                (
                    ...
                    models.JSONField(
                        blank=True,
                        default=dict,
                        help_text="Auto-captured QMS metrics at review time",
                    ),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "iso_clause",
                    models.CharField(
                        blank=True, help_text="e.g. 8.7, 10.2", max_length=20
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "products_services",
                    models.TextField(blank=True, help_text="What they supply"),
                ),
                ("iso_clause", models.CharField(blank=True, max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "iso_clause",
                    models.CharField(
                        blank=True, help_text="e.g. 7.2, 8.5.1", max_length=20
                    ),
                ),
                (
                    "frequency_months",
                    models.IntegerField(default=0, help_text="0 = one-time"),
                ),
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="agents_api.trainingrequirement",
                    ),
                ),
            ],
            options={

...
urlpatterns = [
    ...
    path(
        "critique-countermeasure/",
        rca_views.critique_countermeasure,
        name="rca_critique_countermeasure",
    ),
    ...
    path(
        ...
        rca_views.update_session,
        name="rca_update",
    ),
    path(
        "sessions/<uuid:session_id>/delete/",
        rca_views.delete_session,
        name="rca_delete",
    ),
    path(
        "sessions/<uuid:session_id>/link-a3/", rca_views.link_to_a3, name="rca_link_a3"
    ),
    ...
    path(
        ...
        rca_views.list_rca_actions,
        name="rca_actions",
    ),
    path(
        "sessions/<uuid:session_id>/actions/create/",
        rca_views.create_rca_action,
        name="rca_create_action",
    ),
]

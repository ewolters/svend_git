...
urlpatterns = [
    ...
    path(
        "ncrs/<uuid:ncr_id>/launch-rca/",
        iso_views.ncr_launch_rca,
        name="iso_ncr_launch_rca",
    ),
    ...
    path(
        "audits/<uuid:audit_id>/findings/",
        iso_views.audit_finding_create,
        name="iso_audit_finding",
    ),
    path(
    ...
    path(
        "audits/<uuid:audit_id>/apply-checklist/",
        iso_views.audit_apply_checklist,
        name="iso_audit_apply_checklist",
    ),
    path(
        "audits/clause-coverage/",
    ...
    path(
        ...
        name="iso_training_record",
    ),
    path(
        "training/records/<uuid:record_id>/",
        iso_views.training_record_update,
        name="iso_training_record_update",
    ),
    path(
        "training/records/<uuid:record_id>/files/",
        iso_views.training_record_files,
        name="iso_training_record_files",
    ),
    ...
    path(
        ...
        name="iso_review_narrative",
    ),
    # Management Review Templates
    path(
        "review-templates/",
        iso_views.review_template_list_create,
        name="iso_review_template_list",
    ),
    path(
        "review-templates/default/",
        iso_views.review_template_default,
        name="iso_review_template_default",
    ),
    path(
        "review-templates/<uuid:template_id>/",
        iso_views.review_template_detail,
        name="iso_review_template_detail",
    ),
    # Document Control (clause 7.5) — skeleton
    path("documents/", iso_views.document_list_create, name="iso_document_list"),
    path(
        "documents/<uuid:doc_id>/",
        iso_views.document_detail,
        name="iso_document_detail",
    ),
    path(
        "documents/<uuid:doc_id>/files/",
        iso_views.document_files,
        name="iso_document_files",
    ),
    ...
    path(
        ...
        iso_views.supplier_detail,
        name="iso_supplier_detail",
    ),
    # Electronic Signatures (21 CFR Part 11)
    path("signatures/", iso_views.signature_list_or_sign, name="iso_signatures"),
    path(
        "signatures/<uuid:sig_id>/verify/",
        iso_views.signature_verify,
        name="iso_signature_verify",
    ),
    path(
        "signatures/verify-chain/",
        iso_views.signature_verify_chain,
        name="iso_signature_verify_chain",
    ),
    ...
    path(
        ...
        iso_views.complaint_detail,
        name="iso_complaint_detail",
    ),
    ...
    path(
        "equipment/<uuid:equipment_id>/",
        iso_views.equipment_detail,
        name="iso_equipment_detail",
    ),
    # Study Output Actions (Phase 7) — QMS routing from Studies
    path(
        "study-actions/raise-ncr/",
        iso_views.study_raise_ncr,
        name="iso_study_raise_ncr",
    ),
    path(
        "study-actions/raise-capa/",
        iso_views.study_raise_capa,
        name="iso_study_raise_capa",
    ),
    path(
        "study-actions/schedule-audit/",
        iso_views.study_schedule_audit,
        name="iso_study_schedule_audit",
    ),
    path(
        "study-actions/request-doc-update/",
        iso_views.study_request_doc_update,
        name="iso_study_request_doc_update",
    ),
    path(
        "study-actions/flag-training-gap/",
        iso_views.study_flag_training_gap,
        name="iso_study_flag_training_gap",
    ),
    path(
        "study-actions/flag-fmea-update/",
        iso_views.study_flag_fmea_update,
        name="iso_study_flag_fmea_update",
    ),

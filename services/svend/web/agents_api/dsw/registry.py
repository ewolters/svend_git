...
def _entry(module, category, has_pvalue=False, effect_type=None,
           shadow_type=None, what_if_tier=0, has_narrative=True,
           has_education=False, has_charts=True):
...
ANALYSIS_REGISTRY = {
    ...
    ("viz", "bayes_spc_capability"):  _entry("viz", CAT_VIZ, False, has_narrative=False),
    ("viz", "bayes_spc_changepoint"): _entry("viz", CAT_VIZ, False, has_narrative=False),
    ("viz", "bayes_spc_control"):     _entry("viz", CAT_VIZ, False, has_narrative=False),
    ("viz", "bayes_spc_acceptance"):  _entry("viz", CAT_VIZ, False, has_narrative=False),
...
def get_all_needing_shadow():
    ...
    return [(t, a) for (t, a), e in ANALYSIS_REGISTRY.items()

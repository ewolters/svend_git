...
urlpatterns = [
    ...
    path("<uuid:notebook_id>/conclude/", notebook_views.conclude_notebook, name="notebook_conclude"),
    # Trials
    path("<uuid:notebook_id>/trials/", notebook_views.list_create_trials, name="trial_list_create"),
    path(

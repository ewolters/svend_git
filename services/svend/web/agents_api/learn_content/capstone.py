    ...
    "tool_steps": [
        {
            ...
            "config": {
                ...
                "columns": [
                    ...
                    {"name": "machine", "type": "categorical", "categories": ["A", "B", "C"]},
                    {"name": "operator", "type": "categorical", "categories": ["Smith", "Jones", "Garcia"]},
                    {"name": "diameter_mm", "type": "numeric", "mean": 10.001, "std": 0.011},
        ...
        },
        {
            ...
            "editable_fields": ["severity", "occurrence", "detection", "recommended_action"],
        ...
        },
        {
            ...
            "editable_fields": ["current_condition", "root_cause", "countermeasures", "follow_up"],

...
urlpatterns = [
    ...
    path(
        "<uuid:fmea_id>/rows/<uuid:row_id>/spc-cpk-update/", views.spc_cpk_update_occurrence, name="fmea_spc_cpk_update"
    ),
    # Action items
    ...
    path("<uuid:fmea_id>/rows/<uuid:row_id>/promote-risk/", views.promote_fmea_risk, name="fmea_promote_risk"),

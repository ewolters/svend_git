...
urlpatterns = [
    ...
    # VSM Lifecycle
    path(
        "vsm/<uuid:vsm_id>/promote/", views_xm.promote_vsm, name="xmatrix_vsm_promote"
    ),
    ...
    path(
        "employees/<uuid:emp_id>/", views.employee_detail, name="hoshin_employee_detail"
    ),
    path(
    ...
    path(
        "templates/<uuid:tpl_id>/", views.template_detail, name="hoshin_template_detail"
    ),
    path(

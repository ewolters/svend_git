...
urlpatterns = [
    ...
    path("session/<uuid:session_id>/step/<str:step_id>/execute/", learn_views.execute_step, name="execute_step"),
    path("session/<uuid:session_id>/reset/", learn_views.reset_session, name="reset_session"),

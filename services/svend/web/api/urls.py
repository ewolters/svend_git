...
urlpatterns = [
    ...
    path(
        "internal/whitepapers/analytics/", internal_views.api_whitepaper_analytics, name="internal_whitepaper_analytics"
    ),
    ...
    path(
        "internal/crm/sequences/<uuid:sequence_id>/enroll/", internal_views.api_crm_enroll, name="internal_crm_enroll"
    ),
    path("internal/crm/generate-email/", internal_views.api_crm_generate_email, name="internal_crm_generate_email"),
    path(
        "internal/crm/outreach-metrics/", internal_views.api_crm_outreach_metrics, name="internal_crm_outreach_metrics"
    ),
    ...
    path(
        "internal/features/<uuid:feature_id>/note/", internal_views.api_features_add_note, name="internal_features_note"
    ),

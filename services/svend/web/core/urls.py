...
urlpatterns = [
    ...
    path(
        "projects/<uuid:project_id>/advance-phase/",
        views.project_advance_phase,
        name="project_advance_phase",
    ),
    path(
        "projects/<uuid:project_id>/comment/",
        views.project_comment,
        name="project_comment",
    ),
    path(
        "projects/<uuid:project_id>/recalculate/",
        views.project_recalculate,
        name="project_recalculate",
    ),
    # Hypotheses
    path(
        "projects/<uuid:project_id>/hypotheses/",
        views.hypothesis_list,
        name="hypothesis_list",
    ),
    path(
        "projects/<uuid:project_id>/hypotheses/<uuid:hypothesis_id>/",
        views.hypothesis_detail,
    ...
    path(
        "projects/<uuid:project_id>/evidence/<uuid:evidence_id>/",
    ...
    path(
        "projects/<uuid:project_id>/suggest-lr/",
        views.suggest_likelihood_ratio,
        name="suggest_lr",
    ),
    # Evidence from tools (Coder, DSW)
    path(
        "evidence/from-code/",
        views.create_evidence_from_code,
        name="evidence_from_code",
    ),
    path(
        "evidence/from-analysis/",
        views.create_evidence_from_analysis,
    ...
    path(
        "projects/<uuid:project_id>/datasets/<uuid:dataset_id>/data/",
        views.dataset_data,
        name="dataset_data",
    ),
    # Experiment Designs
    path(
        "projects/<uuid:project_id>/designs/",
        views.experiment_design_list,
        name="experiment_design_list",
    ),
    path(
    ...
    path(
        "org/members/<uuid:membership_id>/role/",
        views.org_change_role,
        name="org_change_role",
    ),
    path(
        "org/members/<uuid:membership_id>/remove/",
        views.org_remove_member,
    ...
    path(
        "org/invitations/<uuid:invitation_id>/cancel/",
    ...
    path(
        "org/sites/<uuid:site_id>/delete/",
        views.org_delete_site,
        name="org_delete_site",
    ),
    ...
    path(
        ...
        name="org_update_employee",
    ),
    path(
        "org/employees/<uuid:employee_id>/delete/",

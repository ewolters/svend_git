...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "plan",
                    models.CharField(
                        choices=[("team", "Team"), ("enterprise", "Enterprise")],
                        default="team",
                        max_length=20,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "details",
                    models.TextField(
                        blank=True, help_text="Detailed description or methodology"
                    ),
                ),
                (
                    "source_type",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "interview_state",
                    models.JSONField(
                        blank=True, help_text="Saved interview progress", null=True
                    ),
                ),
                ...
                (
                    "resolution_summary",
                    models.TextField(
                        blank=True, help_text="What did we learn? What was the answer?"
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            ("inversely_correlates", "inversely correlates with"),
                ...
                (
                    "strength",
                    models.FloatField(
                        default=1.0, help_text="Strength of relationship (0.0 to 1.0)"
                    ),
                ),
                (
                    "confidence",
                ...
                (
                    "effect_size",
                    models.FloatField(
                        blank=True, help_text="Estimated causal effect size", null=True
                    ),
                ),
        ...
        migrations.AddIndex(
            model_name="entity",
            index=models.Index(
                fields=["graph", "entity_type"], name="core_entity_graph_i_ea599a_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="entity",
            index=models.Index(
                fields=["graph", "name"], name="core_entity_graph_i_845fb5_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="hypothesis",
            index=models.Index(
                fields=["project", "status"], name="core_hypoth_project_78670d_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="hypothesis",
            index=models.Index(
                fields=["project", "-current_probability"],
                name="core_hypoth_project_58aae9_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="relationship",
            index=models.Index(
                fields=["graph", "relation_type"], name="core_relati_graph_i_0bed28_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="relationship",
            index=models.Index(
                ...
                name="core_relati_source__40d75f_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="relationship",
            index=models.Index(
                ...
                name="core_relati_target__418c46_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="project",
            index=models.Index(
                fields=["user", "status"], name="core_projec_user_id_9ca548_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="project",
            index=models.Index(
                fields=["tenant", "status"], name="core_projec_tenant__994f2f_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="project",
            index=models.Index(
                fields=["-updated_at"], name="core_projec_updated_fe33f0_idx"
            ),
        ),

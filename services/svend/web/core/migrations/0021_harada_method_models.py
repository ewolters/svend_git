    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.TextField(
                        blank=True,
                        default="",
                        help_text="How this goal serves others at home",
                    ),
                ),
                (
                    "service_at_work",
                    models.TextField(
                        blank=True,
                        default="",
                        help_text="How this goal serves others at work",
                    ),
                ),
                (
                    "perspectives",
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ("likert", "Likert 1-5"),
                            ("forced_choice", "Forced Choice Scenario"),
                        ],
                        max_length=20,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "option_a_label",
                    models.CharField(
                        help_text="Short label for clustering (e.g., 'system_thinker')",
                        max_length=50,
                    ),
                ),
            ...
            fields=[
                ...
                (
                    ...
                    models.TextField(
                        blank=True,
                        default="",
                        help_text="Challenges and positive takeaways",
                    ),
                ),
                (
                    "what_differently",
                    models.TextField(
                        blank=True,
                        default="",
                        help_text="What would you have done differently?",
                    ),
                ),
                (
                    "notes",
                    models.TextField(
                        blank=True,
                        default="",
                        help_text="Additional notes / future actions",
                    ),
                ),
                (
                    "score_comments",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "score",
                    models.PositiveSmallIntegerField(
                        blank=True, help_text="1-5 for Likert dimensions", null=True
                    ),
                ),
                (
                    "option_chosen",
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["user", "dimension", "-timestamp"],
                        name="core_questi_user_id_ccd0e0_idx",
                    ),
                    models.Index(
                        fields=["user", "session_id"],
                        name="core_questi_user_id_e3721f_idx",
                    ),
                ],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["user", "date"], name="core_routin_user_id_a68bc5_idx"
                    )
                ],

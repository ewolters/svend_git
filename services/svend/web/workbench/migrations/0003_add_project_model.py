...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "title",
                    models.CharField(
                        help_text="Short title for the project", max_length=255
                    ),
                ),
                (
                    "hypothesis",
                    models.TextField(help_text="The hypothesis being investigated"),
                ),
                (
                    "description",
                    models.TextField(
                        blank=True, help_text="Additional context, background, or scope"
                    ),
                ),
                (
                    "domain",
                ...
                (
                    "conclusion",
                    models.TextField(
                        blank=True, help_text="Final conclusion about the hypothesis"
                    ),
                ),
                (
                    "conclusion_status",
        ...
        migrations.AddIndex(
            model_name="project",
            index=models.Index(
                fields=["user", "status"], name="projects_user_id_05c680_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="project",
            index=models.Index(
                fields=["user", "-updated_at"], name="projects_user_id_2c9bf1_idx"
            ),
        ),
    ]

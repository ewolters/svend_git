    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "likelihood",
                    models.IntegerField(help_text="1-5: probability of occurrence"),
                ),
                ...
                (
                    "owner",
                    models.CharField(
                        help_text="Person or role responsible", max_length=100
                    ),
                ),
                (
                    "related_crs",
                    models.JSONField(
                        blank=True,
                        default=list,
                        help_text="UUIDs of related ChangeRequests",
                    ),
                ),

    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["tenant_id", "detected_at"],
                        name="drift_tenant_detected",
                    ),
                    models.Index(
                        fields=["enforcement_check", "severity"],
                        name="drift_check_severity",
                    ),
                    ...
                    models.Index(
                        fields=["remediation_due_at"], name="drift_remediation_due"
                    ),
            ...
            fields=[
                ...
                (
                    ...
                    models.BigIntegerField(
                        blank=True,
                        help_text="ID of the log entry with violation",
                        null=True,
                    ),
                ),
                (
                    ...
                    models.JSONField(
                        default=dict,
                        help_text="Detailed information about the violation",
                    ),
                ),
                (
                    "is_resolved",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "id",
                    models.BigAutoField(
                        help_text="Sequential ID for ordering",
                        primary_key=True,
                        serialize=False,
                    ),
                ),
                ...
                (
                    ...
                    models.CharField(
                        db_index=True,
                        help_text="Name of the event being logged",
                        max_length=255,
                    ),
                ),
                (
                    "payload",
                    models.JSONField(default=dict, help_text="Event data and context"),
                ),
                (
                    "payload_hash",
                    models.CharField(
                        help_text="SHA-256 hash of the payload", max_length=64
                    ),
                ),
                (
                    "correlation_id",
                ...
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text="True if this is the first entry in the chain",
                    ),
                ),
            ],
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["tenant_id", "timestamp"], name="audit_tenant_time"
                    ),

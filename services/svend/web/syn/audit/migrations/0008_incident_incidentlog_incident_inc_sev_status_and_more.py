...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "title",
                    models.CharField(
                        help_text="Short description of the incident", max_length=255
                    ),
                ),
                (
                    "description",
                ...
                (
                    "mitigating_at",
                    models.DateTimeField(
                        blank=True, help_text="When mitigation/fix began", null=True
                    ),
                ),
                (
                    "resolved_at",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "to_state",
                    models.CharField(
                        blank=True, help_text="New state of the incident", max_length=20
                    ),
                ),
                (
                    "details",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["incident", "timestamp"], name="inclog_incident_time"
            ),
        ),
        migrations.AddIndex(
            model_name="incidentlog",
            index=models.Index(
                fields=["action", "-timestamp"], name="inclog_action_time"
            ),
        ),
    ]

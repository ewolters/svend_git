...
_event_names = {
    "AUDIT_EVENTS", "emit_audit_event", "build_entry_created_payload",
    "build_genesis_created_payload", "build_integrity_violation_payload",
    "build_chain_verified_payload", "build_chain_verification_failed_payload",
    "build_violation_resolved_payload", "build_drift_violation_payload",
    "build_drift_remediation_available_payload", "build_drift_sla_breached_payload",
    "build_drift_governance_escalated_payload", "build_drift_resolved_payload",
    "build_governance_integrity_violation_payload", "build_governance_drift_alert_payload",
    "build_trail_queried_payload", "build_trail_export_payload", "build_retention_policy_payload",
}

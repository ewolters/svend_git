...
_AGENTS_ROOT = str(Path(__file__).resolve().parent.parent)
if _AGENTS_ROOT not in sys.path:
    sys.path.insert(0, _AGENTS_ROOT)

from agent_core.intent import IntentTracker, Action, AlignmentStatus
from agent_core.sources import SourceManager, Source, SourceType, ResearchFindings
from agent_core.reasoning import CodeReasoner  # Reuse Bayesian reasoning
from agent_core.search import MultiSearch, SearchResult as APISearchResult, DataRetriever
...
# Use SearchResult from agent_core.search (imported as APISearchResult)

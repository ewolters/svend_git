...
#   eric ALL=(ALL) NOPASSWD: /usr/bin/systemctl restart svend, /usr/bin/systemctl restart tempora, /usr/bin/systemctl daemon-reload, /usr/bin/cp /home/eric/kjerne/ops/*.service /etc/systemd/system/*, /usr/bin/cp /home/eric/kjerne/ops/*.timer /etc/systemd/system/*

set -euo pipefail

# ── Constants ────────────────────────────────────────────────────────
DEPLOY_DIR="/home/eric/kjerne"

    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "title",
                    models.CharField(
                        help_text="Short description of the change", max_length=255
                    ),
                ),
                (
                    "description",
                ...
                (
                    "affected_files",
                    models.JSONField(
                        default=list, help_text="List of files to be modified"
                    ),
                ),
                (
                    "implementation_plan",
                    models.JSONField(
                        default=dict, help_text="Steps for implementing the change"
                    ),
                ),
                (
                    "rollback_plan",
                ...
                (
                    "related_change_ids",
                    models.JSONField(
                        default=list, help_text="List of related change request UUIDs"
                    ),
                ),
                (
                    "debt_item",
                ...
                (
                    "author",
                    models.CharField(
                        help_text="Who created the change request", max_length=255
                    ),
                ),
                (
                    "approver",
                    models.CharField(
                        blank=True, help_text="Who approved the change", max_length=255
                    ),
                ),
                (
                    "correlation_id",
            ...
            options={
                ...
                "indexes": [
                    ...
                    models.Index(
                        fields=["status", "-created_at"], name="chg_status_created"
                    ),
                    models.Index(
                        fields=["risk_level", "-created_at"], name="chg_risk_created"
                    ),
                    models.Index(fields=["is_emergency"], name="chg_emergency"),
                    models.Index(fields=["correlation_id"], name="chg_correlation"),
                    models.Index(
                        fields=["author", "-created_at"], name="chg_author_created"
                    ),
                ],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "security_score",
                    models.FloatField(default=0, help_text="Security risk score (1-5)"),
                ),
                (
                    "availability_score",
                    models.FloatField(
                ...
                (
                    "privacy_score",
                    models.FloatField(default=0, help_text="Privacy risk score (1-5)"),
                ),
                (
                    "overall_score",
                    models.FloatField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "actor",
                    models.CharField(
                        help_text="Who or what created this log entry", max_length=255
                    ),
                ),
                (
                    "action",
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["change_request", "timestamp"],
                        name="chglog_request_time",
                    ),
                    models.Index(
                        fields=["action", "-timestamp"], name="chglog_action_time"
                    ),
                ],
            },
        ),
        ...
        migrations.AddIndex(
            model_name="riskassessment",
            index=models.Index(
                fields=["overall_recommendation"], name="risk_recommendation"
            ),
        ),
        migrations.AddIndex(
